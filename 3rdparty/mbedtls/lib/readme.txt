...
- a static runtime (/MTd & /MT) was specified.
- /Z7 :: include debug info in the object files themselves
- /Zl (that's lowercase letter 'l') :: omit C runtime declarations, should _in theory_ allow to link this no matter which runtime flavor is used in the final app
